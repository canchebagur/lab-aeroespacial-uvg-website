...
sections:
  ...
  - block: markdown
    content:
      title: Acerca del Laboratorio Aeroespacial
      subtitle: ''
      text: |
  ...
  - block: features
    content:
      title: Áreas de Trabajo del Laboratorio
      subtitle: ''
      items:
        - name: Nanosatélites
          icon: satellite
          icon_pack: fas
          description: Diseño, integración y operación de nanosatélites tipo CubeSat y sus subsistemas.
        - name: Estación Terrena
          icon: satellite-dish
          icon_pack: fas
          description: Operación de estaciones terrenas para enlace, monitoreo y control de satélites en órbita.
        - name: Sistemas Embebidos
          icon: microchip
          icon_pack: fas
          description: Desarrollo de hardware y firmware para sistemas espaciales y aplicaciones asociadas.
        - name: Pruebas y Validación
          icon: flask
          icon_pack: fas
          description: Pruebas funcionales y ambientales, incluyendo simulación de condiciones espaciales.
        - name: Educación y Divulgación
          icon: chalkboard-teacher
          icon_pack: fas
          description: Formación técnica de estudiantes y divulgación científica en tecnología espacial.
        - name: Colaboración Internacional
          icon: globe
          icon_pack: fas
          description: Cooperación con universidades, agencias espaciales y organismos internacionales.
    design:
      columns: '3'
      spacing:
        padding: ["40px", "0", "40px", "0"]
